    ...
    return (
        <section id="tool-bar" className="bg-gray-100 p-5 rounded border border-gray-300 shadow-xl">
            ...
            <div id="tool-set" className="flex gap-3 justify-center items-center text-white">
                <button className="cursor-pointer bg-black rounded p-2 w-10 h-10 flex justify-center text-xl items-center">B</button>
                <button className="cursor-pointer bg-black rounded p-2 w-10 h-10 flex justify-center text-xl items-center"><i>i</i></button>
                <button className="cursor-pointer bg-black rounded p-2 w-10 h-10 flex justify-center text-xl items-center"><FaLink /></button>
                <button className="cursor-pointer bg-black rounded p-2 w-10 h-10 flex justify-center text-xl items-center"><u>U</u></button>
            </div>
            <select id="block-selection" className="cursor-pointer my-3 bg-white rounded w-full text-left p-1 text-lg border mb-5 border-gray-200 text-slate-800 shadow-lg">
                <option value="Paragraph" >Heading 1</option>
                <option value="Paragraph" >Heading 2</option>
                <option value="Paragraph" >Heading 3</option>
            ...
            <div id="format" className="text my-3 flex justify-center items-center">
                <p className="border rounded border-2 p-1 border-slate-700 py-2 mx-2"><span className="bg-blue-200 rounded">Highlight</span> Text</p>
                <p className="border rounded border-2 p-1 border-slate-700 py-2"><span className="font-extrabold italic text-slate-800 text-lg">Aa</span> <span className="text-slate-900 text-base border border-2 bg-white p-1 font-semibold rounded px-2 text-sm">#404040</span></p>
            </div>
